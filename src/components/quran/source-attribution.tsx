...
const labels: Record<SourceAttribution["contentType"], string> = { "quran-text": "Qur’an text", translation: "Translation", transliteration: "Transliteration", audio: "Audio and reciter", tafsir: "Tafsir source", editorial: "Editorial notice" };
